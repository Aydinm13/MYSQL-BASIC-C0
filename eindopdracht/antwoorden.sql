...
-- Opdracht 8
SELECT COUNT(name) AS totaal_nintendo FROM videogamesales WHERE publisher="Nintendo"
-- Opdracht 9
...
-- Opdracht 10
SELECT ROUND(AVG(NA_Sales)) AS noord_amerika_verkoop, ROUND(AVG(EU_Sales)) AS europa_verkoop, ROUND(AVG(JP_Sales)) AS japan_verkoop FROM videogamesales
-- Opdracht 11
